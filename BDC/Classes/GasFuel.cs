...
namespace BDC.Classes
{
    public class GasFuel
    {
        ...
        public string N_C4H10 { get; set; } = "-";
        public string ISO_C4H10 { get; set; } = "-";
        public string C4H8 { get; set; } = "-";
        public string ISO_C5H12 { get; set; } = "-";
        public string N_C5H12 { get; set; } = "-";
        public string C5H10 { get; set; } = "-";
        public string C6H14 { get; set; } = "-";
